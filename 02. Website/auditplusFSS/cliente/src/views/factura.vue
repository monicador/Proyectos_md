...
<div class =" container">
<div class="row g-3">
    <label for="inputText" class="col-sm-2 col-form-label text-bold"><b> Número de Radicación</b></label>
    <div class="col-sm-3">
...
<div class="row mb-7">
    <label for="inputText" class="col-sm-2 col-form-label"><b>Nit</b></label>
    <div class="col-sm-3">
...
<div class="row mb-7">
    <label for="inputText" class="col-sm-2 col-form-label text-bold"><b>Prefijo</b></label>
    <div class="col-sm-3">
...
<div class="row mb-7">
    <label for="inputText" class="col-sm-2 col-form-label"><b>N° Facturat</b></label>
    <div class="col-sm-3">
...
<div class="row mb-7">
    <label for="inputText" class="col-sm-2 col-form-label"><b>Nivel</b></label>
    <div class="col-sm-3">
...
<div class="row mb-7">
    <label for="inputText" class="col-sm-2 col-form-label"><b>Tipo Id</b></label>
    <div class="col-sm-3">
...
<div class="row mb-7">
    <label for="inputText" class="col-sm-2 col-form-label"><b>Id Paciente</b></label>
    <div class="col-sm-3">
...
<div class="row mb-7">
    <label for="inputText" class="col-sm-2 col-form-label"><b>Nombre Paciente</b></label>
    <div class="col-sm-5">
...
<div class="row mb-7">
    <label for="inputDate" class="col-sm-2 col-form-label"><b>Fecha factura</b></label>
    <div class="col-sm-2">
       <!-- <input type="text" class="form-control my-2" placeholder="Fecha Factura" v-model ="facturar.fechafactura">-->
        <b-form-datepicker  v-model="facturar.fechafactura" class="mb-2"> </b-form-datepicker>
    </div>
</div>

<div class="row mb-3">
    <label for="inputNumber" class="col-sm-2 col-form-label"><b>Valor Factura</b></label>
    <div class="col-sm-3">
...
<div class="row mb-3">
    <label for="inputText" class="col-sm-2 col-form-label"><b>Estado</b></label>
    <div class="col-sm-2">
        <input type="text" class="form-control my-2" placeholder="Estado" v-model ="facturar.estado">
    </div>
</div>
</div>
<button type="submit" class="btn btn-primary btn-lg"><b>Radicar Factura</b></button>
    <br>    
    <br>
